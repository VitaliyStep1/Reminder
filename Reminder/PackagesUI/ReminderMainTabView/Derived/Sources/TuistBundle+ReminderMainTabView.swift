...
/// Since ReminderMainTabView is a static framework, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "ReminderMainTabView_ReminderMainTabView"
        ...
        fatalError("unable to find bundle named ReminderMainTabView_ReminderMainTabView")
    }()
}
