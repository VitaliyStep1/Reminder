...
/// Since ReminderPersistence is a static framework, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "ReminderPersistence_ReminderPersistence"
        ...
        fatalError("unable to find bundle named ReminderPersistence_ReminderPersistence")
    }()
}
